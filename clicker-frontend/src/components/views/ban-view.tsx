...
interface BanViewProps {
  reason?: string;
}

export function BanView({reason}: BanViewProps) {
  const {webApp} = useTelegramStore();

  return (
    <div className="fixed inset-0 bg-red-950 flex flex-col items-center justify-center p-6 text-center">
